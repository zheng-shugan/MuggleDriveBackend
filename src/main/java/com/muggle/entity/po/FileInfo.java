...
public class FileInfo implements Serializable {
  ...
  public String toString() {
    return "文件ID:"
        ...
        + (lastUpdateTime == null
            ? "空"
            : DateUtil.format(lastUpdateTime, DateTimePatternEnum.YYYY_MM_DD_HH_MM_SS.getPattern()))
        + "，0:文件 1:目录:"
        ...
        + (recoveryTime == null
            ? "空"
            : DateUtil.format(recoveryTime, DateTimePatternEnum.YYYY_MM_DD_HH_MM_SS.getPattern()))
        + "，删除标记 0:删除  1:回收站  2:正常:"
